...
Zéro dépendance NuGet : BCL seul + runner d'assertions intégré (justification dans l'historique). Le repo dogfoode son propre workflow CI (tests — dont l'exemple hello-sdd — + lint sur chaque push/PR).
